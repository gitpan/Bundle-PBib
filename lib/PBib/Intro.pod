...
=item [[I<reference>]] or [[I<ref 1>], [I<ref 2>]]
...
other fields (see also L</PBib Reference Types ("CiteType")> below):
...
=item [< I<some comment> >] or [# I<some todo marker> #]
...
I<Hint:> You can process this introduction with pbib to get an idea of 
...
L<PBib::BibliographyStyle>, 
L<PBib::BibItemStyle>,
L<PBib::LabelStyle>, and
L<PBib::ReferenceStyle>.
...
=item thesis, masterthesis, phdthesis
